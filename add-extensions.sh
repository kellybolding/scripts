...
#This script finds individual files anywhere within a directory (here, within "cdo") and renames them by appending the appropriate file extension based on a lookup csv file.
